...
* Class name: FramesControllerTest
* Namespace: 
...
### __assertView
    ...
    void FramesControllerTest::__assertView(integer $frameId)
...
### testIndex
    ...
    void FramesControllerTest::testIndex()
...
### testIndexNotFound
    ...
    void FramesControllerTest::testIndexNotFound()
...
### testIndexNoneContent

    void FramesControllerTest::testIndexNoneContent()
...
### testIndexSettingMode

    void FramesControllerTest::testIndexSettingMode()
...
### testIndexSettingModeNoneContent

    void FramesControllerTest::testIndexSettingModeNoneContent()
