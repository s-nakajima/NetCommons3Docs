...
* Class name: FilesController
* Namespace: 
* Parent class: [FilesAppController](FilesAppController.md)
...
### view
    ...
    void FilesController::view(string $fileName)
...
### download
    ...
    void FilesController::download(string $fileName)
...
### __file
    ...
    void FilesController::__file(string $fileName, boolean $isDownload)
...
#### Arguments
* $fileName **string** - &lt;p&gt;File name&lt;/p&gt;
* $isDownload **boolean** - &lt;p&gt;ダウンロードフラグ true: ダウンロード, false: 表示&lt;/p&gt;
