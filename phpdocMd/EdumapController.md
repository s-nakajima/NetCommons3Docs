...
* Class name: EdumapController
* Namespace: 
* Parent class: [EdumapAppController](EdumapAppController.md)
...
### __initEdumap
    ...
    void EdumapController::__initEdumap()
...
### __parseRequestData
    ...
    array EdumapController::__parseRequestData()
...
### initEdumap
    ...
    boolean EdumapAppController::initEdumap(array $contains)
...
* Visibility: **public**
* This method is defined by [EdumapAppController](EdumapAppController.md)
...
### initTabs
    ...
    void EdumapAppController::initTabs(string $mainActiveTab, string $blockActiveTab)
