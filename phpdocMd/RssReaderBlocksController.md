...
* Class name: RssReaderBlocksController
* Namespace: 
* Parent class: [RssReadersAppController](RssReadersAppController.md)
...
### index
    ...
    void RssReaderBlocksController::index()
...
### add
    ...
    void RssReaderBlocksController::add()
...
### edit
    ...
    void RssReaderBlocksController::edit()
...
### delete
    ...
    void RssReaderBlocksController::delete()
...
### __initRssReader
    ...
    boolean RssReaderBlocksController::__initRssReader()
...
### __parseRequestData
    ...
    array RssReaderBlocksController::__parseRequestData()
...
### initTabs
    ...
    void RssReadersAppController::initTabs(string $mainActiveTab, string $blockActiveTab)
...
* Visibility: **public**
* This method is defined by [RssReadersAppController](RssReadersAppController.md)
