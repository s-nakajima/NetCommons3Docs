...
### beforeValidate
    ...
    boolean EdumapSocialMedium::beforeValidate(array $options)
...
### validateEdumapSocialMedia

    boolean EdumapSocialMedium::validateEdumapSocialMedia(array $data)
