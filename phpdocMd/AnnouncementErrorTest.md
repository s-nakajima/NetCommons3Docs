...
* Class name: AnnouncementErrorTest
* Namespace: 
...
### testSaveAnnouncementByUnknownFrameId

    void AnnouncementErrorTest::testSaveAnnouncementByUnknownFrameId()
