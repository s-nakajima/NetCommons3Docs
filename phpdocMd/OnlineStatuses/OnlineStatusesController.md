...
* Class name: OnlineStatusesController
* Namespace: 
...
### index
    ...
    void OnlineStatusesController::index(integer $frameId)
...
### manage
    ...
    \CakeResponse OnlineStatusesController::manage(integer $frameId)
