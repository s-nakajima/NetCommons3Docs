...
* Class name: OnlineStatusEditController
* Namespace: 
* Parent class: [OnlineStatusesAppController](OnlineStatusesAppController.md)
...
### form
    ...
    \CakeResponse OnlineStatusEditController::form(integer $frameId)
...
### view
    ...
    \CakeResponse OnlineStatusEditController::view(integer $frameId)
...
### edit
    ...
    string OnlineStatusEditController::edit()
