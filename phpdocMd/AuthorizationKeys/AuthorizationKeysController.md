...
* Class name: AuthorizationKeysController
* Namespace: 
* Parent class: [AuthorizationKeysAppController](AuthorizationKeysAppController.md)
...
### view
    ...
    void AuthorizationKeysController::view()
...
### popup
    ...
    void AuthorizationKeysController::popup()
