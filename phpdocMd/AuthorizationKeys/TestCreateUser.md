...
### $useTable
    ...
    public string $useTable = 'create_users'
...
### $hasOne
    ...
    public array $hasOne = array('TestCreateGroup' => array('className' => 'TestNetCommons.TestCreateGroup', 'foreignKey' => 'group_id'))
