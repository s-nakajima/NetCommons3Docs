Controller_BlogEntries_ViewTest
===============
...
* Class name: Controller_BlogEntries_ViewTest
* Namespace: 
...
### testEditLink
    ...
    void Controller_BlogEntries_ViewTest::testEditLink(string $role, boolean $viewEditLink)
...
#### Arguments
* $role **string** - &lt;p&gt;ロール&lt;/p&gt;
* $viewEditLink **boolean** - &lt;p&gt;編集リンクが表示されるか&lt;/p&gt;



### editLinkDataProvider

    array Controller_BlogEntries_ViewTest::editLinkDataProvider()
...
### testViewNotFound
    ...
    void Controller_BlogEntries_ViewTest::testViewNotFound()
...
### testViewWithTag
    ...
    void Controller_BlogEntries_ViewTest::testViewWithTag()
...
### testViewContentCommentPostFailed

    void Controller_BlogEntries_ViewTest::testViewContentCommentPostFailed()
