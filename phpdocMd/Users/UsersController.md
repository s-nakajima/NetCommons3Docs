...
* Namespace: 
* Parent class: [UsersAppController](UsersAppController.md)
...
### view
    ...
    void UsersController::view(string $id)
...
### edit
    ...
    void UsersController::edit(string $id)
...
### delete
    ...
    void UsersController::delete(string $id)
