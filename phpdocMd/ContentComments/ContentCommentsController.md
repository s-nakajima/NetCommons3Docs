...
* Class name: ContentCommentsController
* Namespace: 
* Parent class: [ContentCommentsAppController](ContentCommentsAppController.md)
...
* Visibility: **public**
* This property is defined by [ContentCommentsAppController](ContentCommentsAppController.md)
...
### edit
    ...
    \CakeResponse ContentCommentsController::edit()
