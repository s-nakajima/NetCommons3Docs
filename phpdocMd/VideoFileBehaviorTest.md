...
* Class name: VideoFileBehaviorTest
* Namespace: 
...
### testValidateVideoFile
    ...
    void VideoFileBehaviorTest::testValidateVideoFile()
...
### testValidateVideoFileValidateFail

    void VideoFileBehaviorTest::testValidateVideoFileValidateFail()
...
### testValidateVideoFileEdit

    void VideoFileBehaviorTest::testValidateVideoFileEdit()
...
### testValidateVideoFileEditValidateDeletedFilesFail

    void VideoFileBehaviorTest::testValidateVideoFileEditValidateDeletedFilesFail()
...
### testValidateVideoFileEditValidateFileAssociatedFail

    void VideoFileBehaviorTest::testValidateVideoFileEditValidateFileAssociatedFail()
...
### testSaveVideoFile
    ...
    void VideoFileBehaviorTest::testSaveVideoFile()
...
### testSaveVideoFileEdit

    void VideoFileBehaviorTest::testSaveVideoFileEdit()
...
### testSaveVideoFileEditOverwriteFile

    void VideoFileBehaviorTest::testSaveVideoFileEditOverwriteFile()
...
### testSaveVideoFileEditThumbnail

    void VideoFileBehaviorTest::testSaveVideoFileEditThumbnail()
...
### testDeleteFile
    ...
    void VideoFileBehaviorTest::testDeleteFile()
