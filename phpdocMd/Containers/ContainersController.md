...
* Class name: ContainersController
* Namespace: 
* Parent class: [ContainersAppController](ContainersAppController.md)
...
### index
    ...
    void ContainersController::index(string $id)
