...
* Class name: ContainersControllerTest
* Namespace: 
...
### $fixtures
    ...
    public array $fixtures = array('plugin.containers.container', 'plugin.containers.containers_page')
...
### testIndex
    ...
    void ContainersControllerTest::testIndex()
...
### testIndexContainerMajor

    void ContainersControllerTest::testIndexContainerMajor()
...
### testIndexContainerMain

    void ContainersControllerTest::testIndexContainerMain()
...
### testIndexContainerMinor

    void ContainersControllerTest::testIndexContainerMinor()
...
### testIndexContainerFooter

    void ContainersControllerTest::testIndexContainerFooter()
...
### testIndexNotFound
    ...
    void ContainersControllerTest::testIndexNotFound()
