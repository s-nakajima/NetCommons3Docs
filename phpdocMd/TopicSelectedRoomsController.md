...
* Class name: TopicSelectedRoomsController
* Namespace: 
...
### index
    ...
    void TopicSelectedRoomsController::index()
...
### view
    ...
    void TopicSelectedRoomsController::view(string $id)
...
### add
    ...
    void TopicSelectedRoomsController::add()
...
### edit
    ...
    void TopicSelectedRoomsController::edit(string $id)
...
### delete
    ...
    void TopicSelectedRoomsController::delete(string $id)
