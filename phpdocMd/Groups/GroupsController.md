...
* Class name: GroupsController
* Namespace: 
* Parent class: [GroupsAppController](GroupsAppController.md)
...
### view
    ...
    void GroupsController::view(string $id)
...
#### Arguments
* $id **string** - &lt;p&gt;groups.id&lt;/p&gt;



### add

    void GroupsController::add()
...
### edit
    ...
    void GroupsController::edit(string $id)
...
### delete
    ...
    void GroupsController::delete(string $id)
