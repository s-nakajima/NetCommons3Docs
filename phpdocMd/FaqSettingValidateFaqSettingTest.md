FaqSettingValidateFaqSettingTest
===============
...
* Class name: FaqSettingValidateFaqSettingTest
* Namespace: 
...
### $__defaultData
    ...
    private array $__defaultData = array('FaqSetting' => array('id' => '1', 'faq_key' => 'faq_1', 'use_workflow' => true))
...
### __assertValidationError
    ...
    void FaqSettingValidateFaqSettingTest::__assertValidationError(string $field, array $data, array $expected)
...
### test
    ...
    void FaqSettingValidateFaqSettingTest::test()
...
### testKeyErrorByNotEmptyOnUpdate
    ...
    void FaqSettingValidateFaqSettingTest::testKeyErrorByNotEmptyOnUpdate()
...
### testUseWorkflowErrorByBoolean

    void FaqSettingValidateFaqSettingTest::testUseWorkflowErrorByBoolean()
