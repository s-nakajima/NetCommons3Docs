...
* Class name: QuestionnairesController
* Namespace: 
...
### index
    ...
    void QuestionnairesController::index()
...
### _getPaginateFilter
    ...
    array QuestionnairesController::_getPaginateFilter()
...
### thanks
    ...
    void QuestionnairesController::thanks(integer $frameId, integer $questionnaireId)
...
### add
    ...
    void QuestionnairesController::add()
...
### edit
    ...
    void QuestionnairesController::edit()
...
### delete
    ...
    void QuestionnairesController::delete()
...
### __validateQuestionnaireSetting

    boolean QuestionnairesController::__validateQuestionnaireSetting(array $data)
...
### __setupViewParameters
    ...
    void QuestionnairesController::__setupViewParameters(array $questionnaire)
