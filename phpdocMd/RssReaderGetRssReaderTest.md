...
* Class name: RssReaderGetRssReaderTest
* Namespace: 
...
### testGetRssReader
    ...
    void RssReaderGetRssReaderTest::testGetRssReader()
...
### testGetRssReaderByNoEditable

    void RssReaderGetRssReaderTest::testGetRssReaderByNoEditable()
