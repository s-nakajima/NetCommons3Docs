...
* Class name: UserRolesController
* Namespace: 
* Parent class: [UserRolesAppController](UserRolesAppController.md)
...
### index
    ...
    void UserRolesController::index()
...
### edit
    ...
    void UserRolesController::edit(string $roleKey)
...
#### Arguments
* $roleKey **string** - &lt;p&gt;user_roles.key&lt;/p&gt;



### delete

    void UserRolesController::delete()
