...
* Class name: UsersControllerTest
* Namespace: 
* Parent class: [UsersControllerTestBase](UsersControllerTestBase.md)
...
### $fixtures
    ...
    public array $fixtures = array('plugin.users.user', 'plugin.users.users_language')
...
### testIndex
    ...
    void UsersControllerTest::testIndex()
...
### testView
    ...
    void UsersControllerTest::testView()
...
### testAdd
    ...
    void UsersControllerTest::testAdd()
...
### testEdit
    ...
    void UsersControllerTest::testEdit()
...
### testDelete
    ...
    void UsersControllerTest::testDelete()
