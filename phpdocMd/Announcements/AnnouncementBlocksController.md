...
* Class name: AnnouncementBlocksController
* Namespace: 
* Parent class: [AnnouncementsAppController](AnnouncementsAppController.md)
...
### index
    ...
    void AnnouncementBlocksController::index()
...
### add
    ...
    void AnnouncementBlocksController::add()
...
### edit
    ...
    void AnnouncementBlocksController::edit()
...
### delete
    ...
    void AnnouncementBlocksController::delete()
...
### initTabs
    ...
    void AnnouncementsAppController::initTabs(string $mainActiveTab, string $blockActiveTab)
...
* Visibility: **public**
* This method is defined by [AnnouncementsAppController](AnnouncementsAppController.md)
