...
* Class name: VisualCaptchaController
* Namespace: 
* Parent class: [VisualCaptchaAppController](VisualCaptchaAppController.md)
...
### view
    ...
    void VisualCaptchaController::view()
...
### captcha
    ...
    string VisualCaptchaController::captcha()
...
### captcha_image
    ...
    string VisualCaptchaController::captcha_image(integer $index)
...
### captcha_audio
    ...
    string VisualCaptchaController::captcha_audio()
