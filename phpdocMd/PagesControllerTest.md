...
* Class name: PagesControllerTest
* Namespace: 
...
### $fixtures
    ...
    public array $fixtures = array('plugin.pages.languages_page', 'plugin.pages.page')
...
### testIndex
    ...
    void PagesControllerTest::testIndex()
...
### testPermalink
    ...
    void PagesControllerTest::testPermalink()
...
### testIndexSetting
    ...
    void PagesControllerTest::testIndexSetting()
...
### testAdd
    ...
    void PagesControllerTest::testAdd()
...
### testAddError
    ...
    void PagesControllerTest::testAddError()
