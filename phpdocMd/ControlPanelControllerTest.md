...
* Class name: ControlPanelControllerTest
* Namespace: 
* Parent class: [ControlPanelControllerTestBase](ControlPanelControllerTestBase.md)
...
### $fixtures
    ...
    public array $fixtures = array('plugin.notifications.notification')
...
### testIndex
    ...
    void ControlPanelControllerTest::testIndex()
