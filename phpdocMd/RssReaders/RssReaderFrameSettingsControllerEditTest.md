RssReaderFrameSettingsControllerEditTest
===============
...
* Class name: RssReaderFrameSettingsControllerEditTest
* Namespace: 
...
### testEditGet
    ...
    void RssReaderFrameSettingsControllerEditTest::testEditGet()
...
### testAddFrameWithoutBlock
    ...
    void RssReaderFrameSettingsControllerEditTest::testAddFrameWithoutBlock()
...
### testEditPost
    ...
    void RssReaderFrameSettingsControllerEditTest::testEditPost()
...
### testEditPostWithoutBlock
    ...
    void RssReaderFrameSettingsControllerEditTest::testEditPostWithoutBlock()
...
### testEditPostValidationError

    void RssReaderFrameSettingsControllerEditTest::testEditPostValidationError()
