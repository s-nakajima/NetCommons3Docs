...
* Class name: SearchBoxesController
* Namespace: 
* Parent class: [SearchBoxesAppController](SearchBoxesAppController.md)
...
### view
    ...
    void SearchBoxesController::view(string $frameId)
...
### edit
    ...
    void SearchBoxesController::edit(string $frameId)
...
### initTabs
    ...
    void SearchBoxesAppController::initTabs(string $mainActiveTab)
...
* Visibility: **public**
* This method is defined by [SearchBoxesAppController](SearchBoxesAppController.md)
