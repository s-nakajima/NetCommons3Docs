...
* Class name: PluginManagerController
* Namespace: 
* Parent class: [PluginManagerAppController](PluginManagerAppController.md)
...
### index
    ...
    void PluginManagerController::index()
...
### view
    ...
    void PluginManagerController::view(integer $pluginType, string $pluginKey)
...
#### Arguments
* $pluginType **integer** - &lt;p&gt;Plugin type&lt;/p&gt;
...
### add
    ...
    void PluginManagerController::add()
...
### update
    ...
    void PluginManagerController::update(integer $pluginType)
...
### order
    ...
    void PluginManagerController::order(integer $pluginType)
...
### delete
    ...
    void PluginManagerController::delete(string $id)
