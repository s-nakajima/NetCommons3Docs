...
* Class name: QuestionnaireChoice
* Namespace: 
...
### $belongsTo
    ...
    public array $belongsTo = array('QuestionnaireQuestion' => array('className' => 'QuestionnaireQuestion', 'foreignKey' => 'questionnaire_question_id', 'conditions' => '', 'fields' => '', 'order' => ''))
...
### getDefaultChoice
    ...
    array QuestionnaireChoice::getDefaultChoice()
...
### saveQuestionnaireChoice
    ...
    boolean QuestionnaireChoice::saveQuestionnaireChoice(integer $questionId, integer $status, $choices)
...
#### Arguments
* $questionId **integer** - &lt;p&gt;questionnaire question id&lt;/p&gt;
