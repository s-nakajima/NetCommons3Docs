...
* Namespace: 
* Parent class: [FramesController](FramesController.md)
...
### index
    ...
    void FramesController::index(string $id)
...
* Visibility: **public**
* This method is defined by [FramesController](FramesController.md)
