...
* Class name: QuestionnaireBlocksSetting
* Namespace: 
...
### saveQuestionnaireBlocksSetting

    boolean QuestionnaireBlocksSetting::saveQuestionnaireBlocksSetting(array $data)
...
### validateQuestionnaireBlocksSetting

    boolean QuestionnaireBlocksSetting::validateQuestionnaireBlocksSetting(array $data)
