...
### $useTable
    ...
    public string $useTable = 'create_profiles'
...
### $belongsTo
    ...
    public array $belongsTo = array('TestCreateUser' => array('className' => 'TestNetCommons.TestCreateUser', 'foreignKey' => 'user_id'))
