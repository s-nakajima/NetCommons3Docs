...
* Class name: CircularNoticeFrameSetting
* Namespace: 
...
### $belongsTo
    ...
    public array $belongsTo = array('Frame' => array('className' => 'Frames.Frame', 'foreignKey' => 'frame_key', 'conditions' => '', 'fields' => '', 'order' => ''))
...
### beforeValidate
    ...
    boolean CircularNoticeFrameSetting::beforeValidate(array $options)
...
### prepareCircularNoticeFrameSetting

    mixed CircularNoticeFrameSetting::prepareCircularNoticeFrameSetting(integer $frameId)
...
### getCircularNoticeFrameSetting

    mixed CircularNoticeFrameSetting::getCircularNoticeFrameSetting(string $frameKey)
...
#### Arguments
* $frameKey **string** - &lt;p&gt;circular_notice_frame_settings.frame_key&lt;/p&gt;



### saveCircularNoticeFrameSetting

    boolean CircularNoticeFrameSetting::saveCircularNoticeFrameSetting(array $data)
...
### validateCircularNoticeFrameSetting

    boolean CircularNoticeFrameSetting::validateCircularNoticeFrameSetting(array $data)
...
### getDisplayNumberOptions
    ...
    array CircularNoticeFrameSetting::getDisplayNumberOptions()
