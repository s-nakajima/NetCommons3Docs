...
* Class name: WorkflowControllerViewTest
* Namespace: 
...
### testView
    ...
    void WorkflowControllerViewTest::testView(array $urlOptions, array $assert, string|null $exception, string $return)
...
### testViewByCreatable
    ...
    void WorkflowControllerViewTest::testViewByCreatable(array $urlOptions, array $assert, string|null $exception, string $return)
...
### testViewByEditable
    ...
    void WorkflowControllerViewTest::testViewByEditable(array $urlOptions, array $assert, string|null $exception, string $return)
