...
* Class name: WorkflowControllerDeleteTest
* Namespace: 
...
### testDeleteGet
    ...
    void WorkflowControllerDeleteTest::testDeleteGet(string $role, array $urlOptions, array $assert, string|null $exception, string $return)
...
### testDeletePost
    ...
    void WorkflowControllerDeleteTest::testDeletePost(array $data, string $role, array $urlOptions, string|null $exception, string $return)
...
### testDeleteExceptionError

    void WorkflowControllerDeleteTest::testDeleteExceptionError(string $mockModel, string $mockMethod, array $data, array $urlOptions, string $exception, string $return)
