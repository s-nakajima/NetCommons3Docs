...
### beforeValidate
    ...
    boolean EdumapStudent::beforeValidate(array $options)
...
### validateEdumapStudents

    boolean EdumapStudent::validateEdumapStudents(array $data)
