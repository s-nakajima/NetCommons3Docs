...
* Namespace: 
* Parent class: [FaqsControllerTestBase](FaqsControllerTestBase.md)
...
### testEditGetPermissionEditable

    void BlockRolePermissionsControllerEditTest::testEditGetPermissionEditable()
...
### testEditGetWOPermissionEditable

    void BlockRolePermissionsControllerEditTest::testEditGetWOPermissionEditable()
