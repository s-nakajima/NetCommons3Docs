VideoFileBehaviorExceptionTest
===============
...
* Class name: VideoFileBehaviorExceptionTest
* Namespace: 
...
### testSaveVideoFileException

    void VideoFileBehaviorExceptionTest::testSaveVideoFileException()
...
### testSaveVideoFileSaveFileAssociatedException

    void VideoFileBehaviorExceptionTest::testSaveVideoFileSaveFileAssociatedException()
...
### testDeleteFileException

    void VideoFileBehaviorExceptionTest::testDeleteFileException()
...
### testDeleteFileDeleteFileAssociatedException

    void VideoFileBehaviorExceptionTest::testDeleteFileDeleteFileAssociatedException()
