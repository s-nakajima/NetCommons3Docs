...
* Class name: AccessCountersController
* Namespace: 
* Parent class: [AccessCountersAppController](AccessCountersAppController.md)
...
### index
    ...
    void AccessCountersController::index()
...
### view
    ...
    void AccessCountersController::view()
...
### add
    ...
    void AccessCountersController::add()
...
### edit
    ...
    void AccessCountersController::edit()
...
### delete
    ...
    void AccessCountersController::delete()
...
### __parseRequestData
    ...
    array AccessCountersController::__parseRequestData()
...
### initTabs
    ...
    void AccessCountersAppController::initTabs(string $mainActiveTab, string $blockActiveTab)
...
* Visibility: **public**
* This method is defined by [AccessCountersAppController](AccessCountersAppController.md)
...
### initAccessCounter
    ...
    boolean AccessCountersAppController::initAccessCounter(array $contains)
