...
* Class name: UserAttributesController
* Namespace: 
* Parent class: [UserAttributesAppController](UserAttributesAppController.md)
...
### index
    ...
    void UserAttributesController::index()
...
### add
    ...
    void UserAttributesController::add(integer $row)
...
#### Arguments
* $row **integer** - &lt;p&gt;Add row number&lt;/p&gt;



### edit

    void UserAttributesController::edit(string $key)
...
#### Arguments
* $key **string** - &lt;p&gt;user_attributes.key&lt;/p&gt;



### move

    void UserAttributesController::move()
...
### delete
    ...
    void UserAttributesController::delete()
