QuestionnaireBlocksSettingTest
===============
...
* Class name: QuestionnaireBlocksSettingTest
* Namespace: 
...
### __assertValidationError
    ...
    void QuestionnaireBlocksSettingTest::__assertValidationError(string $field, array $data, array $expected)
...
### testbeforeValidate1
    ...
    void QuestionnaireBlocksSettingTest::testbeforeValidate1()
...
### testsaveQuestionnaireBlocksSetting

    void QuestionnaireBlocksSettingTest::testsaveQuestionnaireBlocksSetting()
...
### testOKsaveQuestionnaireBlocksSetting

    void QuestionnaireBlocksSettingTest::testOKsaveQuestionnaireBlocksSetting()
...
### testvalidateQuestionnaireBlocksSetting

    void QuestionnaireBlocksSettingTest::testvalidateQuestionnaireBlocksSetting()
