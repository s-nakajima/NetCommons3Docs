...
* Namespace: 
* Parent class: [RoomsAppController](RoomsAppController.md)
...
### index
    ...
    void RoomsController::index(integer $spaceId)
...
### add
    ...
    void RoomsController::add(integer $spaceId, integer $roomId)
...
### edit
    ...
    void RoomsController::edit(integer $roomId)
