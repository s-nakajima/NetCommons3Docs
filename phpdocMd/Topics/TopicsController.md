...
* Class name: TopicsController
* Namespace: 
* Parent class: [TopicsAppController](TopicsAppController.md)
...
### index
    ...
    void TopicsController::index(string $frameId)
...
#### Arguments
* $frameId **string** - &lt;p&gt;frameId&lt;/p&gt;



### __setUnitTypeVars

    void TopicsController::__setUnitTypeVars(array $topicFrameSetting)
...
#### Arguments
* $topicFrameSetting **array** - &lt;p&gt;Topic Frame Setting&lt;/p&gt;



### search

    void TopicsController::search(string $frameId)
...
### initTabs
    ...
    void TopicsAppController::initTabs(string $mainActiveTab)
...
* Visibility: **public**
* This method is defined by [TopicsAppController](TopicsAppController.md)
