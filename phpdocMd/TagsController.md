...
* Class name: TagsController
* Namespace: 
* Parent class: [TagsAppController](TagsAppController.md)
...
* This method is defined by [TagsAppController](TagsAppController.md)
