...
* Class name: BlockRolePermissionsControllerEditTest
* Namespace: 
...
### dataProviderRoleAccess
    ...
    array BlockRolePermissionsControllerEditTest::dataProviderRoleAccess()
...
### testAccessPermission
    ...
    void BlockRolePermissionsControllerEditTest::testAccessPermission(string $role, string $exception)
...
### _getPermissionData
    ...
    array BlockRolePermissionsControllerEditTest::_getPermissionData(boolean $isPost)
...
### _assertEditGetPermission

    void BlockRolePermissionsControllerEditTest::_assertEditGetPermission(array $approvalFields, array $result)
...
* $result **array** - &lt;p&gt;結果HTML&lt;/p&gt;



### testEditGet

    string BlockRolePermissionsControllerEditTest::testEditGet(array $approvalFields, string|null $exception, string $return)
...
### testEditPost
    ...
    void BlockRolePermissionsControllerEditTest::testEditPost(array $data, string|null $exception, string $return)
