...
* Class name: BlocksControllerTest
* Namespace: 
...
### $_editController
    ...
    protected string $_editController
...
### dataProviderRoleAccess
    ...
    array BlocksControllerTest::dataProviderRoleAccess()
...
### dataProviderPaginator

    array BlocksControllerTest::dataProviderPaginator()
...
### testIndex
    ...
    void BlocksControllerTest::testIndex()
...
### testIndexNoneBlock
    ...
    void BlocksControllerTest::testIndexNoneBlock()
...
### testAccessPermission
    ...
    void BlocksControllerTest::testAccessPermission(string $role, boolean $isException)
...
* $isException **boolean** - &lt;p&gt;Exceptionの有無&lt;/p&gt;



### testIndexPaginator

    void BlocksControllerTest::testIndexPaginator(integer $page, boolean $isFirst, boolean $isLast)
...
#### Arguments
* $page **integer** - &lt;p&gt;ページ番号&lt;/p&gt;
* $isFirst **boolean** - &lt;p&gt;最初のページかどうか&lt;/p&gt;
* $isLast **boolean** - &lt;p&gt;最後のページかどうか&lt;/p&gt;
